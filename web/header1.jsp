                    ...
                    <ul class="site-menu js-clone-nav d-none d-lg-block">
                      <li class="">
                       ...
                       <!-- <a href="about.jsp">About</a>-->
                         <a href="adcommando.jsp">Add Commando</a>
                      </li>
                     
                      <li><a href="adteam.jsp">Create Team</a></li>
                     
                       <li><a href="adsndntfn.jsp">Send Notification</a></li>
                     <!-- <li class="active"><a href="contact.html">Contact</a></li>-->
                      <li class="has-children">
                        <a href="adviewcmndo.jsp">View Commandos</a>
                        <ul class="dropdown arrow-top">
                          <li><a href="view_memebers.jsp">View Team Members</a></li>
                          <li><a href="adviewntfn.jsp">View Notification & Updates</a></li>
                          <li><a href="adviewcmplnt.jsp">View Complaints & Reply</a></li>
                          <li class="has-children">
